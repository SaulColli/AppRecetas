...
import 'package:flutter_application_1/views/widgets/ingridient_tile.dart';
import 'package:flutter_application_1/views/widgets/review_tile.dart';
import 'package:flutter_application_1/views/widgets/step_tile.dart';
import 'package:flutter_svg/svg.dart';

class RecipeDetailPage extends StatefulWidget {
  final Recipe data;
  // ignore: prefer_const_constructors_in_immutables
  RecipeDetailPage({Key? key, required this.data}) : super(key: key);
